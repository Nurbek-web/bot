...
async def status_task():
	while True:
		await bot.change_presence(activity=discord.Game("c тобой!"))
		await asyncio.sleep(60)
		await bot.change_presence(activity=discord.Game("с Нурбеком"))
		await asyncio.sleep(60)
		await bot.change_presence(activity=discord.Game(f"{config.BOT_PREFIX} help"))
		await asyncio.sleep(60)
		await bot.change_presence(activity=discord.Game("учится"))
		await asyncio.sleep(60)
